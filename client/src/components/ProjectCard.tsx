...
export default function ProjectCard({ title, description, href, icon, tags }: IProject) {
  ...
  return (
    <a
      className="group hover:shadow-lg rounded-xl  transition duration-200 relative border border-slate-200 dark:border-slate-700 w-full my-1"
      href={href}
      aria-label={title}
      target="_blank"
...
function HoverPattern({ mouseX, mouseY, ...gridProps }: any) {
